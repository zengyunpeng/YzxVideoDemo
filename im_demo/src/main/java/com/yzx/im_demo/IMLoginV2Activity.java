...
import com.yzx.tools.CheckPermissionUtil;
    ...
    private void initData(IMLoginV2Activity imLoginActivity) {
        ...
        btn_login.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String overseaAccount = getSharedPreferences("YZX_DEMO", 0).getString("YZX_ACCOUNT_OVERSEA", "");
...
//				RestTools.getToken(mAccount, mHandler);
                ...
                getSharedPreferences("YZX_DEMO", 0).edit()
...
//					IMLoginV2Activity.this.finish();
    ...
    private void getPermission() {
        ...
        CheckPermissionUtil.requestPermissions(this, permissions);
    }
}
