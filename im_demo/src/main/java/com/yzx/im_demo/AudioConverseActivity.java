...
public class AudioConverseActivity extends ConverseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ift.addAction(UIDfineAction.ACTION_DIAL_DTMF);
...
//                  sendBroadcast(new Intent(UIDfineAction.ACTION_DIAL_STATE).putExtra("state", UCSCall.HUNGUP_OTHER));
    ...
    private void initData() {
        isSmartCall = getIntent().getBooleanExtra("isSmartCall", false);
        ...
        if (inCall) {
            ...
            intent.putExtra("smartCall", isSmartCall);
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(UIDfineAction.ACTION_DIAL_STATE)) {
                ...
                if (datas != null) {
                    ...
                    audio_main.setBackgroundDrawable(drawable);
            ...
            } else if (intent.getAction().equals(UIDfineAction.ACTION_DIAL_DTMF)) {
                int dtmfCode = intent.getIntExtra("dtmf", -1);
                Toast.makeText(AudioConverseActivity.this, "按键：" + dtmfCode, Toast.LENGTH_SHORT).show();
            }
        }
    };
