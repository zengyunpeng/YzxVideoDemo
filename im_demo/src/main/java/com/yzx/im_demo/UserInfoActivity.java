...
public class UserInfoActivity extends Activity implements OnClickListener {
    ...
    private TextView tv_other_smart_voice_call;
    ...
    private void initView() {
        ...
        tv_other_smart_voice_call = (TextView) findViewById(R.id.tv_other_smart_voice_call);
    }
    ...
    private void initListener() {
        ...
        tv_other_smart_voice_call.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        boolean smartCall = false;
        switch (v.getId()) {
            case R.id.tv_other_smart_voice_call:
                smartCall = true;
            case R.id.ll_other_voice_call:    // 音频
                ...
                intentVoice.putExtra("isSmartCall", smartCall);
